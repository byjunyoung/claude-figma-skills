...
[무엇을 해결하나](#무엇을-해결하나) · [처음 5분](#처음-5분) · [누가 쓰면 좋은가](#누가-쓰면-좋은가) · [어떤 자리에 서는 도구인가](#어떤-자리에-서는-도구인가) · [어떻게 쓰나](#어떻게-쓰나) · [스킬 목록](#스킬-목록) · [시작하기](#시작하기) · [설정](#설정) · [막혔을 때](#막혔을-때) · [설계 원칙](#설계-원칙) · [pm](#pm--기획-문서) · [둘이 만나는 지점](#둘이-만나는-지점)
...
**넷 다 Figma 파일을 건드리지 않습니다.** 2번은 내 컴퓨터에 파일 하나를 쓰고, 3번은 아무것도 쓰지 않습니다. 남이 작업 중인 파일에 돌려도 안전합니다.

**이게 나에게 맞는 도구인지는 3번에서 갈립니다.** 결과는 화면 이름으로 나옵니다 — 이건 섹션 밖에 나가 있다, 이 화살표는 허공을 가리킨다, 이 복제본은 아무도 원하지 않은 설정을 물고 왔다. 거의 전부가 위반으로 나오면 파일이 엉망인 게 아니라 2번에서 잡은 규칙이 틀린 것이고, 어느 규칙을 풀지는 [막혔을 때](#막혔을-때)에 있습니다.

**설정 파일을 직접 열 일은 없습니다.** 바꿀 것을 그냥 말로 하면 됩니다 — "화면 이름 검사는 그만해", "화면 간격은 120이 아니라 160이야" — Claude가 대신 고칩니다.

각 단계를 자세히 보려면 [시작하기](#시작하기), 기능 하나를 그려 넘기는 한 바퀴는 [어떻게 쓰나](#어떻게-쓰나)에 있습니다.
